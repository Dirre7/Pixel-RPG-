...
export const HERO_CLASSES: Record<HeroClass, {
  ...
  Guerrero: {
    name: 'Guerrero',
    description: 'Especialista en combate cuerpo a cuerpo con alta vida, defensa sólida, bloqueo y espada broadsword.',
    baseStats: {
      hp: 120,
      maxHp: 120,
      mp: 40,
  ...
  Mago: {
    name: 'Mago',
    description: 'Maestro de las artes arcanas con báculo de cristal, regeneración pasiva de maná y hechizos elementales.',
    baseStats: {
      hp: 80,
      maxHp: 80,
      mp: 100,
  ...
  Pícaro: {
    name: 'Pícaro',
    description: 'Luchador ágil y letal con dagas gemelas, máxima evasión y altísimo índice de golpes críticos.',
    baseStats: {
      hp: 95,
      maxHp: 95,
      mp: 60,
  ...
  Paladín: {
    name: 'Paladín',
    description: 'Caballero sagrado protegido por armadura dorada, máximo bloqueo con escudo y regeneración de luz.',
    baseStats: {
      hp: 135,
      maxHp: 135,
      mp: 70,
  ...
  Nigromante: {
    name: 'Nigromante',
    description: 'Invocador de las sombras con túnica del vacío, drenaje de almas con robo de vida y magia oscura.',
    baseStats: {
      hp: 85,
      maxHp: 85,
      mp: 110,
  ...
  Arquero: {
    name: 'Arquero',
    description: 'Tirador certero con arco compuesto, 100% de precisión certera, gran alcance crítico y evasión ágil.',
    baseStats: {
      hp: 90,
      maxHp: 90,
      mp: 65,
  ...
  Berserker: {
    name: 'Berserker',
    description: 'Bárbaro salvaje con daño crítico colosal y robo de vida salvaje, sacrificando su capacidad de esquivar.',
    baseStats: {
      hp: 140,
      maxHp: 140,
      mp: 30,
